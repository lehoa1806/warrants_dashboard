...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://hp10slcyhj.execute-api.ap-southeast-1.amazonaws.com/prod';
    ...
    apigClient.estimatedPriceGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var estimatedPriceGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/estimatedPrice').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(estimatedPriceGetRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.estimatedPricePost = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var estimatedPricePostRequest = {
        ...
        return apiGatewayClient.makeRequest(estimatedPricePostRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.estimatedPriceOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var estimatedPriceOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/estimatedPrice').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
        ...
        return apiGatewayClient.makeRequest(estimatedPriceOptionsRequest, authType, additionalParams, config.apiKey);
    };
    ...
    apigClient.historyGet = function (params, body, additionalParams) {
        ...
        return apiGatewayClient.makeRequest(historyGetRequest, authType, additionalParams, config.apiKey);
    };
    ...
    apigClient.historyPost = function (params, body, additionalParams) {
        ...
        return apiGatewayClient.makeRequest(historyPostRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.historyOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var historyOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/history').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
        ...
        return apiGatewayClient.makeRequest(historyOptionsRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.infoGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        ...
        return apiGatewayClient.makeRequest(infoGetRequest, authType, additionalParams, config.apiKey);
    };
